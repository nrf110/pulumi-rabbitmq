...
export class Provider extends pulumi.ProviderResource {
    ...
    constructor(name: string, args?: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        {
            inputs["cacertFile"] = (args ? args.cacertFile : undefined) || utilities.getEnv("RABBITMQ_CACERT_FILE");
            inputs["endpoint"] = (args ? args.endpoint : undefined) || utilities.getEnv("RABBITMQ_MANAGEMENT_ENDPOINT");
